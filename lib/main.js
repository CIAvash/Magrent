...
let downloadTorrentItem = contextMenu.Item({
    ...
    contentScriptFile: [data.url("js/Nibbler.min.js"), data.url("js/magrent.js"), data.url("js/download-torrent.js")]
});
...
let panel = require("panel").Panel({
    ...
    contentScriptFile: [data.url("js/jquery.min.js"), data.url("js/Nibbler.min.js"), data.url("js/magrent.js"), data.url("js/panel.js")]
});
